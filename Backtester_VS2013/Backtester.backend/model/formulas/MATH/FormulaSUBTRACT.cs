...
namespace Backtester.backend.model.formulas
{
    public class FormulaSUBTRACT : Formula
    {
        ...
        public FormulaSUBTRACT(FacadeBacktester facade, string name, Formula campo1, Formula campo2)
            : base(facade, name)
        {
            this.campo1 = campo1;
            this.campo2 = campo2;
        ...
        public FormulaSUBTRACT(FacadeBacktester facade, string name, Formula campo1, float v2)
            : base(facade, name)
        {
            this.campo1 = campo1;
            this.v2 = v2;
