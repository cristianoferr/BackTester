...
namespace Backtester.backend.model.system
{
     ...
     */
        ...
        public TradeSystem(Config config)
        {
            ...
            GetVariavel(Consts.VAR_STOP_GAP, "Usado para dar algum espaçamento entre a formula e o valor realmente usado", 0, 5, 5); //Usado para dar algum espaçamento entre a formula e o valor realmente usado
            GetVariavel(Consts.VAR_RISCO_TRADE,"Valor percentual máximo que um trade pode ter de risco", 0, 10, 50);
            ...
            GetVariavel(Consts.VAR_MAX_CAPITAL_TRADE,"Valor absoluto máximo que um trade pode ter", 10000f, 5, 1000000);
