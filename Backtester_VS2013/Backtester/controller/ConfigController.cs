...
namespace Backtester.controller
{
    public class ConfigController : IController, ICaller
    {
        ...
        public void UpdateApplication(Carteira carteira,MonteCarlo mC, int countLoops, int totalLoops)
        {
            ...
            frmPrincipal.dataGridRuns.Rows[rowLine].Cells[colIndex++].Value = Util.FormatCurrency(mC.getCapitalFinal());
            frmPrincipal.dataGridRuns.Rows[rowLine].Cells[colIndex++].Value = Util.FormatCurrency(mC.getMaxCapital());
            frmPrincipal.dataGridRuns.Rows[rowLine].Cells[colIndex++].Value = Util.FormatCurrency(mC.getMinCapital());
            frmPrincipal.dataGridRuns.Rows[rowLine].Cells[colIndex++].Value = Util.FormatCurrency(mC.winLossRatio);
            ...
            frmPrincipal.dataGridRuns.Rows[rowLine].Cells[colIndex++].Value = Util.FormatCurrency(mC.totalGanho);
            frmPrincipal.dataGridRuns.Rows[rowLine].Cells[colIndex++].Value = Util.FormatCurrency(mC.totalPerdido);
            frmPrincipal.dataGridRuns.Rows[rowLine].Cells[colIndex++].Value = Util.FormatCurrency(mC.percAcerto);
